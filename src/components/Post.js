            ...
            <section className="container mx-auto">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 ">
                    ...
                    <article>
                        ...
                        <a target="_blank" href={`https://${post.slug.current}`}>

                        <span className="block h-40 relative rounded shadow leading-snug bg-white border-l-8 border-green-400"
                        key = {index}>
                            ...
                            <span className="block relative h-full flex justify-end items-end pr-4 pb-4">
                                <h3 
                                className=" hover:opacity-100 text-gray-800 text-sml font-blog px-3 py-4 hover:bg-red-300 text-gray-0 bg-opacity-2 rounded hover:text-white ">
                                    {post.title}
                                </h3>
